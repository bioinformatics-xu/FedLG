...
class coronary01(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/coronary01/X_train.npy")
            self.targets = np.load("data/coronary01/y_train.npy")
        else:
            self.data = np.load("data/coronary01/X_test.npy")
            self.targets = np.load("data/coronary01/y_test.npy")
